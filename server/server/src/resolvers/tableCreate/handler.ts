 ...
 *    8base invoke-local tableCreate -p src/resolvers/tableCreate/mocks/request.json
 *
 *  (2) Default mock file location using -m flag:
 *    8base invoke-local tableCreate -m request
 *
 ...
 *    8base generate mock tableCreate -m [MOCK_FILE_NAME]
 */
